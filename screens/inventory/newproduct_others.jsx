...
const NewProductOthers = ({ navigation }) => {
  //Handle Data
  ...
  const [expirationDate, setExpirationDate] = useState("2023-01-31"); // Replace with your actual expiration date
  ...
  const [items, setItems] = useState([
    {
      label: "Pcs",
      value: "Pcs",
      textStyle: { fontSize: 5, fontFamily: "DMMono" },
    },
    { label: "Kg", value: "Kg", textStyle: { fontSize: 5 } },
    { label: "L", value: "L", textStyle: { fontSize: 5 } },
    { label: "Others", value: "Others", textStyle: { fontSize: 5 } },
  ]);
  ...
  const handleModalClose = () => {
    // Close the modal and update the selected item if needed
    setModalVisible(false);
    // You may perform additional actions here based on the entered value in the modal
  };

  const handleOtherValueChange = (text) => {
    setOtherValue(text);
  };
...
export default NewProductOthers;
