...
import { getMonthlyAggregatedReportsGraph } from "../../integration/report";
import { Dimensions } from "react-native";
import { useEffect, useState } from "react";

const MonthlyGraph = ({ navigation }) => {
  const Dashboard = () => {
  ...
  console.log("--------------------")
  console.log("Agrr: ", aggregatedReportsMonthly)
  ...
  return (
    <View style={styles.scannerui}>
      ...
      <View style={{ justifyContent: "center", alignItems: "center" }}>
        ...
        <View style={{top:350}}>
          <View>
            <TouchableOpacity onPress={()=>{setIsVisible(true)}} style={{ elevation:10 , width:100, height:25, backgroundColor: "#ED254E", justifyContent: "center", alignItems: "center", alignSelf: "flex-end", marginRight: 10, borderRadius: 50}}>
            <Text style={{fontFamily: "DMSansBold", fontSize:10}}>Show Data</Text>
            </TouchableOpacity>
            </View>
            <View>
